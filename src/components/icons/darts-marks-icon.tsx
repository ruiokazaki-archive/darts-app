...
const SvgComponent = ({
  ...
  <svg
    ...
    {...props}
  >
    <title>darts marks icon</title>
    {marksCount === 1 && (
      <path
        fill='#fff'
        fillRule='evenodd'
        d='m42.667 0-42 42 6 6 42-42-6-6Z'
        clipRule='evenodd'
      />
    )}
    {marksCount === 2 && (
      <path
        fill='#fff'
        fillRule='evenodd'
        d='M18 24 0 42l6 6 18-18 18 18 6-6-18-18L48 6l-6-6-18 18L6 0 0 6l18 18Z'
        clipRule='evenodd'
      />
    )}
    {marksCount === 3 && (
